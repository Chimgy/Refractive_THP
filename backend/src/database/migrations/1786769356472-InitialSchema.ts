...
export class InitialSchema1786769356472 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_837f73e37f7433e200611d9384" ON "projects"  ("companyId", "slug") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "raw_telemetry_snapshots" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "projectId" character varying, "payload" jsonb NOT NULL, "userAgent" character varying, "receivedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "raw_telemetry_snapshots_pkey" PRIMARY KEY ("id", "receivedAt")) PARTITION BY RANGE ("receivedAt")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "company_invites" ADD CONSTRAINT "FK_e13fe4c1efb3b5e8b5e225e8ddc" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "company_invites" ADD CONSTRAINT "FK_24a9083452fd79bbb5ba83490c9" FOREIGN KEY ("createdByUserId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "projects" ADD CONSTRAINT "FK_87fa45e3f4517658b98e5c55b9c" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "company_invites" DROP CONSTRAINT "FK_24a9083452fd79bbb5ba83490c9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "company_invites" DROP CONSTRAINT "FK_e13fe4c1efb3b5e8b5e225e8ddc"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_361204254bd7035d94772cba49"`,
    );
    await queryRunner.query(`DROP TABLE "telemetry_metrics"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e5679f2099fb08736126446dcd"`,
    );
    await queryRunner.query(`DROP TABLE "telemetry_error_fingerprints"`);
    await queryRunner.query(`DROP TABLE "refresh_tokens"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_837f73e37f7433e200611d9384"`,
    );
